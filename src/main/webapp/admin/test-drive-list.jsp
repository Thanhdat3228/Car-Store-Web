...
<aside class="sidebar">
    ...
    <ul class="nav-links">
        ...
        <li><a href="${pageContext.request.contextPath}/admin/test-drives" class="active"><i class="fas fa-calendar-check"></i>Lịch lái thử</a></li>
        <li><a href="#"><i class="fas fa-users"></i>Khách hàng</a></li>
        <li><a href="#"><i class="fas fa-chart-line"></i>Thống kê</a></li>
        <li><a href="#"><i class="fas fa-logo"></i> Quản lý hãng xe</a>
