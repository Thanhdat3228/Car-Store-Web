...
<aside class="sidebar">
    ...
    <ul class="nav-links">
        <li><a href="${pageContext.request.contextPath}/admin/cars"><i class="fas fa-car"></i> Quản lý kho xe</a></li>
        <li><a href="${pageContext.request.contextPath}/admin/catalog" class="active"><i class="fas fa-list"></i> Quản
            lý danh mục</a></li>
        <li><a href="${pageContext.request.contextPath}/index.jsp"><i class="fas fa-home"></i> Xem trang web</a></li>
        <li style="margin-top:auto"><a href="${pageContext.request.contextPath}/LogoutServlet"><i
