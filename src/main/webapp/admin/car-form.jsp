...
<aside class="sidebar">
    ...
    <ul class="nav-links">
        <li><a href="#" class="active"><i class="fas fa-car"></i> Quản lý kho xe</a></li>
...
<main class="main-content">
    ...
    <section class="page-content">
        <div class="page-header">
            ...
            <a href="${pageContext.request.contextPath}/admin/car_form.jsp" class="btn btn-primary"><i class="fas fa-plus"></i> Thêm xe mới</a>
        </div>
