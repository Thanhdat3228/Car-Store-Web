        ...
        <c:when test="${not empty sessionScope.user}">
            <div class="user-profile">
                ...
                <div class="profile-wrapper" id="profileWrapper">
                    ...
                    <%-- Nút Đăng xuất (nằm cạnh nút user, style giống nút Đăng ký) --%>
